...
use GlennRaya\Xendivel\Services\BalanceService;
use GlennRaya\Xendivel\Services\DisbursementService;
use GlennRaya\Xendivel\Services\InvoiceService;
use GlennRaya\Xendivel\Services\OtcService;
use GlennRaya\Xendivel\Services\PayoutService;
use GlennRaya\Xendivel\Services\QrService;
use GlennRaya\Xendivel\Services\XenPlatformService;
...
class Xendivel extends XenditApi
{
     ...
     * XenPlatform API.
     */
    public static function xenPlatform(): XenPlatformService
    {
        return new XenPlatformService;
    }

    /**
     * Get the total available balance of an account.
     */
    ...
    /**
     * Create or manage payout links.
     */
    public static function payoutLink(): PayoutService
    {
        return new PayoutService;
    }

    /**
     * Create transactions using Xendit's Disbursement API.
     */
    public static function disbursement(): DisbursementService
    {
     ...
     * Create invoice.
     */
    public static function invoicing(): InvoiceService
    {
        return new InvoiceService;
    }

    public static function qrCode(): QrService
    {
    ...
    public static function payWithEwallet($payload): self
    {
        ...
        $payload = ! is_array($payload) ? $payload->toArray() : $payload;
